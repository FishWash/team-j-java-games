...
public class KeyInputHandler
{
  ...
  private final int p1_shootKey = KeyEvent.VK_SPACE;

  private final int p2_moveForwardKey = KeyEvent.VK_UP;
  private final int p2_moveBackwardKey = KeyEvent.VK_DOWN;
  private final int p2_turnLeftKey = KeyEvent.VK_LEFT;
  private final int p2_turnRightKey = KeyEvent.VK_RIGHT;
  private final int p2_shootKey = KeyEvent.VK_ENTER;
